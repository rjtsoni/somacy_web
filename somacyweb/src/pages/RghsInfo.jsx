        ...
        <div>
            <section className='bg-white py-16 px-6 text-center'>
                ...
                <p className='MT-4 text-gray-500 max-w-xl mx-auto'>
                    Search from 1000+ tests with specialized RGHS benefits for goverment employees.
                </p>
                ...
                <div className='mt-4 text-sm text-gray-500'>
                    Popular:
                    <span className='ml-2 text-blue-600 cursor-pointer'>Full Body Checkup</span>
                    <span className='ml-2 text-blue-600 cursor-pointer'>Diabetes Screen</span>
                    <span className='ml-2 text-blue-600 cursor-pointer'>Thyroid Profile</span>
                </div>
            </section>
            ...
            <section className='py-12 px-6 max-w-7xl mx-auto'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mt-8'>
                    {[
                        { name: "Heart", icon: <Heart className="w-6 h-6" />, count: "15 Tests", bgColor: "bg-red-50", iconColor: "text-red-500" },
                        { name: "Diabetes", icon: <Droplet className="w-6 h-6" />, count: "10 Tests", bgColor: "bg-blue-50", iconColor: "text-blue-500" },
                        { name: "Liver", icon: <Activity className="w-6 h-6" />, count: "12 Tests", bgColor: "bg-orange-50", iconColor: "text-orange-500" },
                        { name: "Kidney", icon: <Shield className="w-6 h-6" />, count: "8 Tests", bgColor: "bg-green-50", iconColor: "text-green-500" },
                        { name: "Thyroid", icon: <Activity className="w-6 h-6" />, count: "5 Tests", bgColor: "bg-purple-50", iconColor: "text-purple-500" },
                        { name: "Bones", icon: <Bone className="w-6 h-6" />, count: "7 Tests", bgColor: "bg-yellow-50", iconColor: "text-yellow-600" },
                    ].map((item, index) => (
                        <div
                            key={index}
                            ...
                            <div className={`w-16 h-16 flex items-center justify-center rounded-full ${item.bgColor} ${item.iconColor}`}>
                                {item.icon}
                            </div>
                ...
                <div className='grid md:grid-cols-3 gap-6 mt-6'>
                    <div className='bg-white rounded-xl shadow-sm border p-6 flex flex-col'>
                        <div className='flex justify-between items-start'>
                            ...
                            <span className='text-xs text-gray-400 font-medium'>By Dr. Lal PathLabs</span>
                        </div>
                        ...
                        <p className='text-sm text-gray-500 mt-2 flex-grow'>
                            Includes 85 parameters: Liver, Kidney, Lipid, Thyroid, Iron & more.
                        </p>
                        ...
                        <div className='mt-4 flex items-center gap-2'>
                            ...
                            <span className='text-xs font-bold text-green-600 bg-green-50 px-2 py-1 rounded'>62% OFF</span>
                        </div>
                    ...
                    <div className='bg-white rounded-xl shadow-sm border p-6 flex flex-col'>
                        <div className='flex justify-between items-start'>
                            ...
                            <span className='text-xs text-gray-400 font-medium'>By Metropolis</span>
                        </div>
                    ...
                    <div className='bg-white rounded-xl shadow-sm border p-6 flex flex-col'>
                        <div className='flex justify-between items-start'>
                            ...
                            <span className='text-xs text-gray-400 font-medium'>By Thyrocare</span>
                        </div>
                        ...
                        <div className='mt-4 flex items-center gap-2'>
                            ...
                            <span className='text-xs font-bold text-green-600 bg-green-50 px-2 py-1 rounded'>45% OFF</span>
                        </div>
