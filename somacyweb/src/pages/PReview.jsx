      ...
      {/* <header className="bg-white sticky top-0 z-50 border-b border-gray-100 px-4 md:px-12 py-2.5 flex items-center justify-end">
        <div className="hidden md:flex items-center gap-8 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
          ...
          <div className="w-8 h-8 rounded-full border border-slate-100 overflow-hidden cursor-pointer shadow-sm">
            <img
              src="https://ui-avatars.com/api/?name=User&background=f1f5f9&color=64748b&bold=true"
              alt="User"
            />
          </div>
        </div>
      ...
      <main className="flex-1 max-w-full mx-auto px-4 md:px-8 py-2 md:py-4">
        <div className="flex flex-col gap-4">
          <div className="bg-white border border-slate-200/60 rounded-[1.5rem] p-4 md:p-5 shadow-sm relative overflow-hidden flex flex-col md:flex-row items-center gap-4">
            <div className="flex-1 text-center md:text-left">
              ...
              <h1 className="text-2xl md:text-4xl font-black text-slate-900 mb-2 tracking-tight">
                ...
                <span className="text-blue-600">being reviewed</span>
              </h1>
              <p className="text-slate-500 text-[14px] md:text-[16px] leading-relaxed max-w-xl font-medium">
                Our certified pharmacist is currently reviewing your{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            <div className="lg:col-span-8 bg-white rounded-[1.5rem] p-5 md:p-6 pb-2 shadow-sm border border-slate-200/60">
              <h3 className="text-[13px] font-black text-slate-800 mb-4 flex items-center gap-2 uppercase tracking-widest">
                Activity Log
                <span className="text-[8px] font-black bg-emerald-50 text-emerald-600 px-1.5 py-0.5 rounded-full border border-emerald-100">
                  Live
                </span>
              </h3>
                ...
                {[
                  {
                    ...
                    time: "Completed at 10:00 AM",
                  },
                  {
                    title: "AI Initial Scan Complete",
                    time: "Completed at 10:02 AM",
                  },
                  {
                    title: "Pharmacist Reviewing",
                    time: "Completed at 10:03 AM",
                  },
                  { title: "Order Authorized", time: "Ready for Checkout" },
                ].map((step, idx, arr) => (
                  <div
                    key={idx}
                    className={`flex gap-6 ${idx !== arr.length - 1 ? "pb-5" : ""} relative group`}
                  >
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              <div className="bg-blue-600 rounded-[1.5rem] p-5 text-white shadow-lg shadow-blue-200/50 relative overflow-hidden">
                <h4 className="text-blue-100 text-[10px] font-black uppercase tracking-[0.2em] mb-1 opacity-80">
                  Estimated Wait
                </h4>
              ...
              <div className="bg-white border border-slate-200/60 rounded-[1.5rem] p-5 shadow-sm">
                ...
                <h4 className="text-[13px] font-bold text-slate-800 mb-1 tracking-tight">
                  Quick Tip
                </h4>
                <p className="text-[12px] text-slate-500 leading-relaxed font-medium">
                  Ensure RGHS card details match the prescription to avoid any
                  delays.
                </p>
              </div>
          ...
          <div className="mt-1 text-center">
            <h2 className="text-[14px] font-black text-slate-900 mb-3 tracking-tight uppercase tracking-[0.1em]">
              What happens next?
            </h2>
              ...
              {[
                {
                  ...
                  desc: "Cart will be unlocked.",
                  color: "bg-blue-50 text-blue-600",
                },
                {
                  icon: <CreditCard className="w-3.5 h-3.5" />,
                  title: "Payment",
                  desc: "Choose RGHS method.",
                  color: "bg-indigo-50 text-indigo-600",
                },
                {
                  icon: <Truck className="w-3.5 h-3.5" />,
                  title: "Home Delivery",
                  desc: "Dispatch to your door.",
                  color: "bg-emerald-50 text-emerald-600",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="bg-white rounded-[1.5rem] py-10 px-8 border border-slate-200/60 shadow-sm flex items-center gap-6 text-left hover:border-blue-200 transition-colors"
                >
                  <div
                    className={`w-14 h-14 flex-shrink-0 ${item.color} rounded-2xl flex items-center justify-center shadow-sm`}
                  >
                    {React.cloneElement(item.icon, { className: "w-7 h-7" })}
                  </div>
                  <div>
                    <h4 className="text-[16px] font-black text-slate-900 leading-tight mb-1">
                      {item.title}
                    </h4>
