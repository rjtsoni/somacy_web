...
const Genericfinder = () => {
    return (
        <section className="py-2 md:py-4 bg-slate-50 flex justify-center items-center font-sans">
            <div className="max-w-7xl w-full bg-white rounded-[40px] shadow-xl shadow-slate-200/50 flex flex-col lg:flex-row gap-6 p-6 md:p-8 border border-slate-100 transition-all duration-500 hover:shadow-2xl hover:shadow-slate-300/50">
