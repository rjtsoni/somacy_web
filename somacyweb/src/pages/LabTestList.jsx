    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex flex-col hover:shadow-md transition relative h-full">
        ...
        {test.rghsCashless && (
            <div className="flex items-center gap-2 bg-[#e8f5e9] border rounded-lg px-2 py-1 mb-3">
                <ShieldCheck size={12} />
                <span className="text-[11px] font-bold text-[#2e7d32]">RGHS Cashless</span>
        ...
        <div className="mt-auto">
            <div className="flex items-center justify-between mb-3">
                <div>
                    <span className="text-[11px] text-gray-400 block">Retail Price</span>
...
export default function LabTestList() {
    ...
    const configMap = {
        ...
        health: { label: "Health", component: <Healthcategory />, listLabel: "Packages" },
        bestsellers: { label: "Bestsellers", component: <Bestseller />, listLabel: "Products" },
    };
                            ...
                            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 text-left">
                                {currentItems.map((test) => (
                                    <TestCard
                                        ...
                                        test={test}
                                        onDetail={() =>
                                            navigate(`/lab-test/${category}/${toSlug(test.name)}`, {
                                                state: { test, category },
                                            })
                                        }
                                    />
