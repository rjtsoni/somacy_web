  ...
  <div className="w-80 p-4 bg-white border-2 border-[#135bec] rounded-xl relative overflow-hidden">
    <div className="flex items-start gap-4">
      ...
      <div>
        ...
        <p className="text-xs text-[#135bec] font-bold">Paracetamol (500mg)</p>
        <p className="text-xs text-gray-500 mt-1">GlaxoSmithKline</p>
        <div className="mt-2">
    ...
    <div className="bg-white rounded-xl p-5 border border-[#e7ebf3] hover:shadow-lg transition">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-[#135bec] font-bold">
            Paracetamol (500mg)
          </p>
          ...
          {!mrp && <p className="text-xs text-gray-400 mt-0.5">/ 10 tablets</p>}
        </div>
...
const MedicineComparison = () => {
  ...
  const columns = [
    ...
    { header: "Status", accessor: "status" },
    {
      header: "Retail Price",
      accessor: "retail",
      render: (row) => <div className="font-medium">{row.retail}</div>,
    },
  ];
