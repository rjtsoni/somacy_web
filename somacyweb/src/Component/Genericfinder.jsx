...
const Genericfinder = () => {
    return (
        <section className="py-2 md:py-4 bg-slate-50 font-sans">
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="w-full bg-white rounded-[40px] shadow-xl shadow-slate-200/50 flex flex-col lg:flex-row gap-6 p-6 md:p-8 border border-slate-100 transition-all duration-500 hover:shadow-2xl hover:shadow-slate-300/50">
                    ...
                    <div className="flex-[1.4] flex flex-col justify-center">
                        ...
                        <p className="text-base text-slate-600 leading-relaxed mb-6 max-w-xl font-medium">
                            Search your prescribed medicine and find high-quality generic equivalents that are <span className="text-blue-600 font-bold">equally effective but much more affordable.</span>
                        </p>
                        ...
                        <div className="relative flex items-center mb-6 max-w-lg group">
                            ...
                            />
                            <button className="absolute right-2 px-6 py-2 bg-blue-600 text-white rounded-full font-bold text-xs tracking-wide hover:bg-blue-700 shadow-lg shadow-blue-200">
                                Compare
                            </button>
                        </div>
                    ...
                    <div className="flex-1">
                        <div className="h-full bg-[#FFFBF1] p-6 rounded-[30px] text-center flex flex-col items-center justify-center border border-amber-100 relative overflow-hidden group">
                            ...
                            <p className="text-sm text-slate-600 leading-relaxed mb-6 max-w-[260px] font-medium">
                                Our generic medicines are sourced only from WHO-GMP certified facilities.
                            </p>
