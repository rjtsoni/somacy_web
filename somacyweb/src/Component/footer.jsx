    ...
    return (
        <footer className="bg-[#f5f7fa] pt-10 pb-2 border-t border-slate-200">
            <div className="max-w-full mx-auto px-8 lg:px-12">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-7 gap-x-8 gap-y-12 pb-10 border-b border-slate-200">
                    <div className="flex flex-col space-y-6 lg:col-span-2">
                        ...
                        <p className="text-slate-600 text-[14px] font-bold leading-relaxed">
                        ...
                        <div className="flex flex-col space-y-2.5">
                            <a href="mailto:contact@somacy.com" className="flex items-center gap-2 text-slate-600 hover:text-blue-600 transition-colors group">
                                <Mail size={15} className="text-slate-400 group-hover:text-blue-600" />
                                <span className="text-[13px] font-semibold truncate">contact@somacy.com</span>
                            </a>
                            <a href="tel:+911234567890" className="flex items-center gap-2 text-slate-600 hover:text-blue-600 transition-colors group">
                                <Phone size={15} className="text-slate-400 group-hover:text-blue-600" />
                                <span className="text-[13px] font-semibold">+91 12345 67890</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col  space-y-5 ">
                        ...
                        <ul className="space-y-3">
                            {['Cashless RGHS Order', 'Retail Medicine Store', 'Diagnostic Lab Booking', 'Ayurvedic Essentials'].map((item) => (
                                <li key={item}><a href="#" className="text-[14px] font-semibold text-slate-500 hover:text-blue-600 transition-all">{item}</a></li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col space-y-5">
                        <div>
                            <h3 className="text-[12px] font-bold text-slate-900 uppercase tracking-widest mb-4">Follow Us On</h3>
                            <div className="flex gap-2">
                                {[Facebook, Youtube, Instagram, Twitter].map((Icon, idx) => (
                                    <a key={idx} href="#" className="w-10 h-10 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-blue-600 transition-all">
                                        <Icon size={20} />
                                    </a>
                                ))}
                            </div>
                        ...
                        <div className="flex flex-col gap-2">
                            <h3 className="text-[12px] font-bold text-slate-900 uppercase tracking-widest mb-2">Download App</h3>
                            <div className="flex flex-col gap-2">
